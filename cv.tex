...
%------ degrees --------
\def \majorwidth{.125\textwidth}
\def \uniwidth{.275\textwidth}
\def \yearwidth{.2\textwidth}
%\def \mywidth{10em}


\begin{tabularx}{\textwidth}{p{.1\textwidth}@{\hskip 4pt} p{\majorwidth} | p{\uniwidth} | p{\yearwidth}}
