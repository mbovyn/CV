...
\textsc{Office Address:} Pfotenhauerstr. 108\hphantom{0107}\\
 &
...
\def \poswidth{\widthof{BSE Mechanical Engineering}}

\begin{tabularx}{\textwidth}{p{\poswidth} | p{.5\textwidth}}
...
\begin{tabularx}{\textwidth}{p{\poswidth} | p{.5\textwidth}}
\begin{minipage}{\widthof{PhD Physics}}
PhD Physics
MS Physics
\end{minipage}
&
...
\begin{tabularx}{\textwidth}{p{\poswidth} | p{.5\textwidth}}
\begin{minipage}{\widthof{BSE Mechanical Engineering}}
BS Physics\\
