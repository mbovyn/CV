...
%%\rule[-1.2ex]{0pt}{0pt}
%\multicolumn{1}{l}{ 
%\textbf{The University of California, Irvine}}
%
%&
%
%\multicolumn{1}{r}{Fall 2014 - Present}\\
%
%& Advisors: Jun Allard and Steve Gross  \\
%\textsc{PhD Physics} & Mathematical and Computational Systems Biology Gateway Program\\
%& Concentration in Chemical and Materials Physics \\ 
%
%%\multicolumn{2}{lr}{ \rule[-1.2ex]{0pt}{0pt} \rule{0pt}{2.6ex}
%%\textbf{Northern Arizona University} &
%%Fall 2007 - Winter 2012
%%}\\
%
%& Minor in Mathematics \\
%\textsc{BS Physics} & Minor in Physical Science\\
%\textsc{BSE Mech Eng} & Honors Program\\
%& Overall GPA: 3.5/4.0\\
%& Math and Physics GPA: 3.8/4.0
%
%\end{tabular*}

%\begin{tabular}{r | l}
%
%\multicolumn{2}{l}{ \rule[-1.2ex]{0pt}{0pt}
%\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} lr}
%\textbf{The University of California, Irvine} &
%Fall 2014 - Present
%\end{tabular*}}\\
...
%& Concentration in Chemical and Materials Physics \\ 
%
%\multicolumn{2}{l}{ \rule[-1.2ex]{0pt}{0pt} \rule{0pt}{2.6ex}
%\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} lr}
%\textbf{Northern Arizona University} &
%Fall 2007 - Winter 2012
%\end{tabular*}}\\
...
%\begin{tabular}{rl}	
%
%\textsc{Graduate} & The University of California, Irvine\\ \\
%
%& \begin{tabular}{| l} 
%\textbf{PhD in Physics} \\ 
%Advisors: \textsc{Jun Allard} and \textsc{Steve Gross} \\
%Mathematical and Computational Systems Biology Gateway Program\\
%Concentration in Chemical and Materials Physics \\ 
%\end{tabular} \\
%&\\
%
%%------------------------------------------------
%
%\textsc{Undergraduate} & Northern Arizona University \\ \\
%
%& \begin{tabular}{| l | l} 
%\textbf{BS Physics} & \textbf{BSE Mechanical Engineering} \\ 
%Minor in Mathematics & Minor in Physical Science
%\end{tabular} \\
%
%&\\
%
...
%
%Current & NSF Integrative Graduate Education and Research Traineeship (IGERT) DGE-1144901 to Vasan Venugopalan in the Beckman Laser Center \\
%& NIH R01 GM123068 to Jun Allard and Steve Gross\\
%%\multicolumn{2}{c}{} \\
%Years 2 \& 3 & NIH T32 Training Grant EB009418-07 to Arthur Lander and Qing Nie\\
%%\multicolumn{2}{c}{} \\
%Year 1 & Mathematical, Computational and Systems Biology Fellowship \\
%& NSF GRFP Honorable Mention \\
%%\multicolumn{2}{c}{} \\
%
%Undergraduate & The Outstanding Senior of the NAU College of Engineering, Forestry and Natural Sciences \\
% & NAU Gold Axe Award \\
% & NAU Department of Physics and Astronomy Bedwell Scholarship \\
% & NAU Department of Physics and Astronomy Adel Scholarship \\
% & Raytheon Missile Systems Scholarship \\
% & NAU Department of Physics and Astronomy Chair's Scholarship \\
% & Arizona Board of Regent's High Honors Tuition Scholarship \\
% & Dean's List - 7 Semesters


%\begin{tabular}{p{\widthof{Undergraduate}} | l}
%\begin{tabular}{>{\raggedleft}p{\widthof{Undergraduate}} | p{\linewidth-\widthof{Undergraduate | }}}
...
%
%\item Set up and managed a Microsoft SQL server backed web site to provide public access to the herbarium database
%
%\item Cataloged and organized herbarium preserved plant specimens
%
%\item Assisted on lab field trips to collect and preserve plant specimens and gather data on native and invasive species from around the island of Puerto Rico
%
%\item Assisted with maximum entropy modeling to predict habitable ranges of plants based on data gathered on field trips and open access climatic data
%
%\end{itemize}}
%\end{minipage}
%\\
